...
OpCode = Enum('OpCode', [
    ...
    'ALLOCD',  # allocate dict object, push oid x
    'SETD',    # pop value x, pop key val, pop oid y, set obj(y)[A] = x
    'GETD',    # pop key, pop oid y, push obj(y)[x] onto stack
    'KEYS', # pop oid, push list of push the oid of the list created of the keys
    'IN', # pop value, pop oid, check if it is in the dictionary
